(function(){
  ...
  var App = {
    ...
    exportReport: function(){
      ...
      var totalPro = list.reduce(function(a,r){ var pr = prorrateo(r); return a + (pr?pr.monto:0); },0);
      lines.push(['Monto prorrateado (activadas)', totalPro.toFixed(2)].map(csvField).join(';'));
