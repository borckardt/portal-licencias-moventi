...
async function loadAuth() {
  ...
  // copia cacheada vieja durante unos segundos. Rompemos el caché con un
  // query param único + cache:'no-store' para no leer nunca una contraseña
  // desactualizada justo después de un reset (bug real: el reset parecía
  // funcionar pero el siguiente login fallaba con la clave anterior).
